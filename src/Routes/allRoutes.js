...
import GeneralInfo from "../pages/Forms/FormLayouts/GeneralInfo";

import LocationPicker from "../pages/Forms/FormLayouts/LocationPicker";
//Calendar
...
import VidhyarthiSankhya from '../pages/Forms/FormLayouts/VidhyarthiSankhya'
// Base Ui
...
import BasicElements1 from "../pages/Forms/BasicElements/BasicElements1";
import User_Settings from "../pages/Forms/BasicElements/User_Settings";
import ArjView from "../pages/Forms/BasicElements/ArjView";

import FormSelect from "../pages/Forms/FormSelect/suwidha";
import FormSelect1 from "../pages/Forms/FormSelect/bhautiksuwidha";
import FormSelect2 from "../pages/Forms/FormSelect/formSelect2";
...
import Payment from "../pages/Forms/FormLayouts/payment";
//Emanyata
...
import GrantedSchool from "../pages/Forms/FormLayouts/granted";
// User Profile
...
import TrackingForm1 from "../pages/Forms/BasicElements/TrackingForm1 ";
// import TrackingForm from "../pages/Forms/BasicElements/TrackingForm"
import Settings1 from "../pages/Forms/BasicElements/User_Settings";
import GeneralInfo1 from "../pages/Forms/FormLayouts/GeneralInfo1";
...
const authProtectedRoutes = [
  ...
  { path: "/विद्यार्थी-संख्या", component: <VidhyarthiSankhya /> },
  { path: "/payment", component: <Payment /> },
  { path: "/granted-school", component: <GrantedSchool/> },
  { path: "/ट्रॅकिंग", component: <TrackingForm1/> },
  { path: "/सामान्य-माहिती", component: <GeneralInfo/> },
  { path: "/सामान्य-माहिती1", component: <GeneralInfo1 /> },

  
  { path: "/location", component: <LocationPicker/> },

  // { path: "/ट्रॅकिंग-अर्ज ", component: <Tracking/> },
  ...
  // Forms
  { path: "/Samanya", component: <BasicElements /> },
  { path: "/forms-elements1", component: <BasicElements1 /> },
  { path: "/profile-setting", component: <User_Settings /> },
  { path: "/forms-select", component: <FormSelect /> },
  { path: "/forms-select1", component: <FormSelect1 /> },
  { path: "/forms-select2", component: <FormSelect2 /> },

  { path: "/अर्ज", component: <ArjView /> },
