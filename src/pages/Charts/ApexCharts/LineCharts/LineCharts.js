...
// };
const LinewithDataLabels = ({ dataColors }) => {
    // Memoize the colors array and chart series to avoid recalculations on every render
    const LinewithDataLabelsColors = useMemo(() => getChartColorsArray(dataColors), [dataColors]);
