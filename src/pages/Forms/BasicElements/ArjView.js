    ...
    return (
        <React.Fragment>
            ...
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="अर्ज  पाहा" pageTitle={<a href='/dashboard' > डॅशबोर्ड </a>}  />
                    <Row className="my-4">
                        <Col>
                            <h1 className="fs-4 mb-3 fw-bold"> 
                        ...
                        <Col lg={12} > 
                            <Card>
                              <CardHeader className="d-flex justify-content-between align-items-center bg-white">
                                <h4 className="card-title m-4 fs-4 fw-semibold">अर्ज</h4>
                                  
                              </CardHeader>
                              <CardBody>
                                { /* शाळेची माहिती */ }
                                <div className='border m-2 p-4' >
                                  <h5 className="mb-3 fw-semibold">शाळेची माहिती</h5> 
                                  <Table bordered>
                                ...
                                <div className='border m-2 p-4' >
                                  <div className="d-flex justify-content-between align-items-center mb-3">
                                    <h5 className="mb-0 fw-semibold">सामान्य माहिती</h5>   
                                    <div>
                                      <div className="form-check form-check-inline">
                                        <input className="form-check-input" type="radio" name="infoStatus" id="accept" value="accept" defaultChecked />
                                        <label className="form-check-label" htmlFor="accept">स्विकार द्या</label>
                                      </div>
                                      <div className="form-check form-check-inline">
                                ...
                                <div className='border m-2 p-4'>
                                  <div className="d-flex justify-content-between align-items-center mb-3">
                                    <h5 className="mb-0 fw-semibold">विद्यार्थी संख्या</h5> 
                                    <div>
                                      <div className="form-check form-check-inline">
                                ...
                                <div className='border m-2 p-4'>
                                  <div className="d-flex justify-content-between align-items-center mb-3" >
                                    <h5 className="fw-semibold mb-3">इमारत सुविधा / शाळेच्या परिसराचे क्षेत्रफळ / एकूण बांधकामाचे क्षेत्र</h5> 
                                    <div>
                                        <div className="form-check form-check-inline">
                                          <input className="form-check-input" type="radio" name="studentCountStatus" id="accept" value="accept" defaultChecked />
                                          <label className="form-check-label" htmlFor="accept">स्वीकारा</label>
                                  ...
                                  <h5 className="fw-semibold mb-3">कार्यालय / भांडार / मुख्याध्यापक खोली / वर्गखोल्यांची संख्या व मापे नकाशानुसार</h5>
                                  <Table bordered>
                                    <thead className="table-light">
                                      <tr>
                                       <th>एस आर क्र.</th>
                                ...
                                <div className='mt-4' >
                                  <h5 className="fw-semibold mb-3">शौचालय व प्रवेश सुविधा</h5>
                                  <Table bordered>
                                    <thead className="table-light">
                                      <tr>
                                        <th>एस आर क्र.</th>
                                ...
                                <div className='mt-4' >
                                  <h5 className="fw-semibold mb-3">इतर सुविधा</h5> 
                                  <Table bordered>
                                    <thead className="table-light">
                                      <tr>
                                        <th>आवश्यक सुविधा</th>
                                ...
                                <div className='border m-2 p-4'>
                                  <div className="d-flex justify-content-between align-items-center mb-3">
                                    <h5 className="mb-0 fw-semibold">मंजूर शाळा दस्तऐवज चेकलिस्ट</h5>
                                    <div>
                                ...
                                <div className='border m-2 p-4'> 
                                  <h5 className="fw-semibold mb-3">तपासणी अधिकारी अभिप्राय</h5>
